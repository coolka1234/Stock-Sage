...
class Ui_MainMenuWindow(object):
    def setupUi(self, MainMenuWindow):
        ...
        self.textEditTitle.setGeometry(QtCore.QRect(20, 50, 971, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.widget.setGeometry(QtCore.QRect(20, 10, 981, 31))
        ...
        self.textEditId = QtWidgets.QTextEdit(parent=self.widget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.textEditAuthor = QtWidgets.QTextEdit(parent=self.widget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.textEditUrl = QtWidgets.QTextEdit(parent=self.widget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
